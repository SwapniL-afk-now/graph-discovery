...
def serialize_nodes(
    ...
    if not nodes:
        return (f"{title}\n(no matching nodes found)\n"
                "— What you can do next —\n"
                "• broaden the search: vkg_search with a shorter/simpler query\n"
                "• drop type filters: vkg_query(node_type=\"any\")\n"
                "• the graph may be missing this region → frame_inspect_tool on the "
                "suspected time range to look at raw frames")
